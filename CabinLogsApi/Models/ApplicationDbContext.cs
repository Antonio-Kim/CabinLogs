...
public class ApplicationDbContext : DbContext
{
	...
	protected override void OnModelCreating(ModelBuilder modelBuilder)
	{
		...
		new Cabin
		{
			...
			image = "http://localhost:5000/cabin-001.jpg"
		},
		new Cabin
		{
			id = 2,
			...
			image = "http://localhost:5000/cabin-002.jpg"
		},
		new Cabin
		{
			id = 3,
			...
			image = "http://localhost:5000/cabin-003.jpg"
		},
		new Cabin
		{
			id = 4,
			...
			image = "http://localhost:5000/cabin-004.jpg"
		},
		new Cabin
		{
			id = 5,
			...
			image = "http://localhost:5000/cabin-005.jpg"
		},
		new Cabin
		{
			id = 6,
			...
			image = "http://localhost:5000/cabin-006.jpg"
		},
		new Cabin
		{
			id = 7,
			...
			image = "http://localhost:5000/cabin-007.jpg"
		},
		new Cabin
		{
			id = 8,
			...
			image = "http://localhost:5000/cabin-008.jpg"
		}
	);
		...
		{
			id = 17,
			created_at = DateTime.UtcNow.AddDays(-16),
		...
		{
			id = 18,
			created_at = DateTime.UtcNow.AddDays(-18),
			startDate = DateTime.UtcNow.AddDays(-4),
			endDate = DateTime.UtcNow.AddDays(-1),
			numberOfNights = 3,
			numGuests = 6,
		...
		{
			id = 21,
			created_at = DateTime.UtcNow.AddDays(-55),
